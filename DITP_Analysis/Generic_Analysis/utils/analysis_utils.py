...
def classify_one_extraction(
    ...
    """
    Classify one extraction with elementary subjects and push new ones to mongo
    """

    # get elementary subjects corresponding to the brand
